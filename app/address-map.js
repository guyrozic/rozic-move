 ...
 *
 * ⚠️ **גיאוקודינג הפוך דורש `authUser`** (ראו `reverseGeocode` ב-
 * `address-autocomplete.js`) — תקין כאן כי שני הדפים היחידים שקוראים
 * לפונקציה הזו יושבים מאחורי `requireAuth()`.
 *
