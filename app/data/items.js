...
export const ALL_ROOMS = [
    {
        ...
        items: [
            ...
            { key: 'nightstand_small', label: 'שידה קטנה (עד 40 ס"מ)', icon: '🗃', defaultQty: 2, heavy: false, fragile: false, needsDisassembly: false, synonyms: ['שידת ליל קטנה'] },
            ...
            { key: 'ottoman_small', label: 'פוף / הדום קטן (עד 50 ס"מ)', icon: '🪑', defaultQty: 1, heavy: false, fragile: false, needsDisassembly: false, synonyms: [] },
            { key: 'ottoman_medium', label: 'פוף / הדום בינוני (50–80 ס"מ)', icon: '🪑', defaultQty: 1, heavy: false, fragile: false, needsDisassembly: false, synonyms: [] },
            ...
            { key: 'bookshelf_large', label: 'כוננית גדולה (90–180 ס"מ)', icon: '📚', defaultQty: 1, heavy: true, fragile: false, needsDisassembly: true, synonyms: ['ספרייה'] },
            ...
            { key: 'clothes_rack_small', label: 'עמוד מתלה בגדים קטן (עד 100 ס"מ)', icon: '👔', defaultQty: 1, heavy: false, fragile: false, needsDisassembly: true, synonyms: ['קולב עומד'] },
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'coffee_table_medium', label: 'שולחן סלון נמוך בינוני (80–140 ס"מ)', icon: '🪑', defaultQty: 1, heavy: true, fragile: true, needsDisassembly: false, synonyms: [] },
            ...
            { key: 'tv_75_90', label: 'טלוויזיה 75–90"', icon: '📺', defaultQty: 1, heavy: true, fragile: true, needsDisassembly: false, synonyms: ['טלוויזיה גדולה מאוד'] },
            { key: 'tv_90_120', label: 'טלוויזיה 90–120"', icon: '📺', defaultQty: 1, heavy: true, fragile: true, needsDisassembly: false, synonyms: ['טלוויזיה ענקית', 'טלוויזיה 100'] },
            { key: 'speakers_medium', label: 'רמקולים בינוניים (זוג, עד 40 ס"מ)', icon: '🔊', defaultQty: 1, heavy: false, fragile: true, needsDisassembly: false, synonyms: [] },
            ...
            { key: 'chandelier_small', label: 'נברשת קטנה (מפורקת, עד 50 ס"מ קוטר)', icon: '💡', defaultQty: 1, heavy: false, fragile: true, needsDisassembly: true, synonyms: [] },
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'washer_dryer_small', label: 'מכונת כביסה/מייבש קטן (עד 45 ס"מ)', icon: '🫧', defaultQty: 1, heavy: true, fragile: false, needsDisassembly: false, notes: 'לנקז ולנעול תוף אם רלוונטי', synonyms: [] },
            ...
            { key: 'dishwasher_small', label: 'מדיח כלים 45 ס"מ (קטן)', icon: '🍽', defaultQty: 1, heavy: true, fragile: false, needsDisassembly: false, synonyms: [] },
            ...
            { key: 'dining_table_medium', label: 'שולחן אוכל בינוני (120–180 ס"מ)', icon: '🍽', defaultQty: 1, heavy: true, fragile: false, needsDisassembly: true, synonyms: [] },
            ...
            { key: 'coffee_machine_small', label: 'מכונת קפה קטנה (עד 20 ס"מ)', icon: '☕', defaultQty: 1, heavy: false, fragile: true, needsDisassembly: false, synonyms: ['נספרסו', 'מכונת קפסולות'] },
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'sunshade_small', label: 'שמשייה קטנה (עד 2.5 מ׳ קוטר)', icon: '⛱', defaultQty: 1, heavy: false, fragile: false, needsDisassembly: true, synonyms: [] },
            ...
            { key: 'bbq_grill_small', label: 'מנגל קטן (עד 80 ס"מ)', icon: '🍖', defaultQty: 1, heavy: false, fragile: false, needsDisassembly: false, synonyms: ['גריל חשמלי'] },
            ...
            { key: 'potted_plant_medium', label: 'עציץ בינוני (30–60 ס"מ)', icon: '🪴', defaultQty: 2, heavy: false, fragile: true, needsDisassembly: false, synonyms: [] },
            ...
            { key: 'garden_swing_small', label: 'נדנדת גינה קטנה (עד 150 ס"מ)', icon: '🪢', defaultQty: 1, heavy: false, fragile: false, needsDisassembly: true, synonyms: [] },
            ...
            { key: 'outdoor_bench_small', label: 'ספסל גינה קטן (עד 150 ס"מ)', icon: '🪑', defaultQty: 1, heavy: false, fragile: false, needsDisassembly: false, synonyms: [] },
            ...
            { key: 'pilates_reformer', label: 'מכשיר פילאטיס (רפורמר)', icon: '🧘', defaultQty: 1, heavy: true, fragile: false, needsDisassembly: false, synonyms: ['רפורמר', 'reformer', 'מיטת פילאטיס'] },
            ...
            { key: 'vacuum_cleaner', label: 'שואב אבק', icon: '🧹', defaultQty: 1, heavy: false, fragile: false, needsDisassembly: false, synonyms: ['רובוט שואב אבק', 'שואב אבק רובוטי', 'שואב אבק'] },
    ...
    },
    {
        ...
        items: [
            { key: 'desk_small', label: 'שולחן עבודה קטן (עד 100 ס"מ)', icon: '🖥', defaultQty: 1, heavy: false, fragile: false, needsDisassembly: false, synonyms: [] },
            { key: 'desk_medium', label: 'שולחן עבודה בינוני (100–140 ס"מ)', icon: '🖥', defaultQty: 1, heavy: false, fragile: false, needsDisassembly: false, synonyms: [] },
            ...
            { key: 'meeting_table_medium', label: 'שולחן ישיבות בינוני (200–350 ס"מ)', icon: '🪑', defaultQty: 1, heavy: true, fragile: false, needsDisassembly: true, synonyms: [] },
            ...
            { key: 'desktop_monitor', label: 'מסך מחשב (עד 32 אינץ\')', icon: '🖥', defaultQty: 1, heavy: false, fragile: true, needsDisassembly: false, synonyms: ['מסך', 'מוניטור'] },
            { key: 'printer_small', label: 'מדפסת קטנה (עד 45 ס"מ)', icon: '🖨', defaultQty: 1, heavy: false, fragile: false, needsDisassembly: false, synonyms: [] },
            ...
            { key: 'photocopier_small', label: 'מכונת צילום קטנה (עד 60 ס"מ)', icon: '🖨', defaultQty: 1, heavy: true, fragile: false, needsDisassembly: false, synonyms: [] },
            ...
            { key: 'paper_shredder_small', label: 'מגרסת נייר קטנה (עד 35 ס"מ)', icon: '📄', defaultQty: 1, heavy: false, fragile: false, needsDisassembly: false, synonyms: [] },
    ...
    },
    {
        ...
        items: [
            { key: 'keyboard_small', label: 'קיבורד קטן / נייד (ללא רגליים)', icon: '🎹', defaultQty: 1, heavy: false, fragile: true, needsDisassembly: false, synonyms: ['פסנתר חשמלי קטן', 'סינטיסייזר'] },
...
const PACKING_NONE_KEYS = new Set([
    ...
    'treadmill', 'exercise_bike', 'weight_bench', 'elliptical', 'multi_trainer', 'pilates_reformer', 'rowing_machine', 'pull_up_bar',
